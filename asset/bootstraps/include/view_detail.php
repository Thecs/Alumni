                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table2" align="center">
                        <tbody>
							...
							<tr>
                              ...
                              <td style="text-align: left"><input type="text" name="alumnus_regisdata_congrat" id="alumnus_regisdata_congrat" class="inp-form" style="width:300px;height:30px;" value="<?=$result['alumnus_regisdata_congrat']?>" disabled></td>
                            </tr>
                        </tbody>
                    </table>
