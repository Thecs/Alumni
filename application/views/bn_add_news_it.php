...
<html>
    ...
    echo form_open('admin/save_news_it');
    ?>

    <div align="left"><a href="<?=base_url()."admin/pr_it"?>"><sub><?=img($data_image_back)?></sub></a></div>
    ...
    <div style="height: 30px"></div>
        ...
        <?=br(2)?>
        <input type="submit" name="submit" value="ประกาศข่าว IT" class="bn_post_news" />
    <?php
    echo form_close();
    //</form>
    ?>
