...
<html>
    <body>
        ...
        ?>
        <div align="left"><a href="<?=base_url()."admin"?>"><sub><?=img($data_image_back)?></sub></a><a href="<?=base_url()."admin/bn_add_news"?>"><sub><?=img($data_image_write_news)?></sub></a></div>
        ...
        <table width="900px" id="bn_table_list"  border="1">
            <tbody>
                ...
                <?php
                $query_webnews = $this -> model_news -> select_news();
